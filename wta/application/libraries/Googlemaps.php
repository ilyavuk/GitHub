...
//	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	
		...
		if($marker['magicBox']){
		  ...
		  $marker_output .= 'google.maps.event.addListener(marker_'.count($this->markers).', \'mouseover\', function() {
									
								ibLabe'.count($this->markers).'.show();	

								}); 
								
								';
		
		$marker_output .= 'google.maps.event.addListener(marker_'.count($this->markers).', \'mouseout\', function() {
									
								ibLabe'.count($this->markers).'.hide();	
		...
		$marker_output .= 'var myOptions = {
											 content: \'<div class="magicBox">'. $marker['magicBox'] .'</div>\'
											,disableAutoPan: true
											,zIndex: 1000
											,position: myLatlng
											,closeBoxURL: ""
								...
								var ibLabe'.count($this->markers).' = new InfoBox(myOptions);	
								ibLabe'.count($this->markers).'.open(map); ';
...
//	+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++	
	...
	function create_map()
	{
		...
		$this->output_html .= '<div id="'.$this->map_div_id.'" class="sixteen columns map"></div>';
