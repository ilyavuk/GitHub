  						...
  						if(raw.data.msg !== undefined){
							...
							var outputM = jQuery.parseJSON(decodeURIComponent(raw.data.msg));
							   ...
							   if(outputM.deletePost !== undefined){ 
								    ...
								    var comment_caught= '<li class="ten columns alpha omega post'+outputM.admin+' delete" data-id="'+scope_comments_id_ape+'" ><div class="bouble"><h3>'+ outputM.userName.replace(/~/g,'"')+'</h3>'+outputM.comment.replace(/~/g,'"');
