<div id="main-content"> <!-- Main Content Section with everything --> 
    ...
    <h2><?=$event->title?></h2>
    <p id="page-intro"><span><a href="<?=base_url().$event->url_title?>">View Event</a></span><span><a href="<?=base_url()?>admin/events/reports/<?=$event->id?>">View Reports</a></span></p>
    ...
    <div class="content-box"><!-- Start Content Box -->
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          <form action="<?=base_url()?>admin/events/edit/<?=$event->id?>" method="post">
            <fieldset>
				 <?php  
                   $data = array(
                ...
                <p>
                    ...
                    echo form_dropdown('venues_id', $position ,$event->venues_id, 'class="small-input"');
                    ?>
              ...
              <p>
				...
				<input  class="text-input small-input" type="text" id="title" name="title" value="<?=$event->title?>">
               ...
               <p>
				...
				<input  class="text-input small-input" type="text" id="url_title" name="url_title" value="<?=$event->url_title?>">
              ...
              <p><label for="description">Description:</label>
                 <textarea class="text-input text area wysiwyg" rows="5" cols="20" name="description"><?=$event->description?></textarea></p>
               ...
               <p><label for="category">Category <em>*</em></label>
                    ...
                    echo form_dropdown('category', $position2, $event->category,'class="small-input"');
                    ?>
                ...
                <p><label for="date">Date and Time event starts: <em>*</em></label>
                    <input  class="text-input small-input timepicker_a" type="text" name="start_date" value="<?=date("m/d/Y H:i",$event->start_date)?>">  
                ...
                <?php endif; ?>             
                 ...
                 <p><label for="time">Date and Time event ends: <em>*</em></label>
                    <input  class="text-input small-input timepicker_a" type="text" name="end_date" value="<?=date("m/d/Y H:i",$event->end_date)?>">  
                ...
                <p><label for="youtube">Youtube:</label>
                    <input  class="text-input small-input" type="text" id="youtube" name="youtube" value="<?=$event->youtube?>">  
                </p>

                <p><label for="vimeo">Vimeo:</label>
                    <input  class="text-input small-input" type="text" id="vimeo" name="vimeo" value="<?=$event->vimeo?>">  
                </p>
                 <p><label for="live_video">Live Video:</label>
                    <textarea class="text-input medium-input" rows="4" cols="20" name="live_video"><?=$event->live_video?></textarea>  
                </p>                         
                <p><label for="poll1">Poll1:</label>
                    <input  class="text-input small-input" type="text" id="poll1" name="poll1" value="<?=$event->poll1?>">  
                </p>
                <p><label for="poll2">Poll2:</label>
                    <input  class="text-input small-input" type="text" id="poll2" name="poll2" value="<?=$event->poll2?>">  
                </p>  
                <p>
                    Num Of Attending  <?=$num_att?>
                </p>              
                      ...
                      <h3>Upload banner</h3>
  						...
  						<p><label for="is_active:">Is active:</label>
							<input type="checkbox" name="is_active" value="1"  <?=($event->is_active == 1)?'checked="checked"':false?> />✔</p>  
                <input class="button" name="submit_event_form" type="submit" value="Submit" />
              </p>
            </fieldset>
            <div class="clear"></div>
            <!-- End .clear -->
...
<p>
<label for="img_decription">Image decription</label><br/>
...
function createUploaderBanner(){
	...
	var uploader = new qq.FileUploader({
		...
		onComplete: function(id, fileName, responseJSON){
			...
			var innerHTML = '<img src="<?=base_url()?>phpThumb/phpThumb.php?src=/assets/banners/'+ responseJSON.img + '&amp;w=280&amp;h=120&amp;zc=1&amp;aoe=1?x='+new Date().getTime()+ '" /><a href="#" class="delBan" >Delete X</a><br/>';
