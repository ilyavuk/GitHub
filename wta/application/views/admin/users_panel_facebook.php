...
<?php foreach($users_data as $user_data): ?>          
              <tr>
                ...
                <td> <img src="http://graph.facebook.com/<?=$user_data->username?>/picture" width="30px" /></td>
                ...
                <td><!-- Icons --> 
                 <a href="<?=base_url().'admin/admin_users_delete/'.$user_data->id.'/1'?>" title="Delete"><img src="<?=base_url()?>assets/img/icons/cross.png" alt="Delete" /></a></td>
              </tr>
<?php endforeach; ?> 
<?php endif; ?>         
</form>                 
...
$(function() {
	  ...
	  $('#applyForm').click(function(e){
		 ...
		 if($('#applyDrop').val() == 'delete'){
		    $("#applySelected").attr("action", "<?=base_url()?>admin/multy_users_delete/f");
